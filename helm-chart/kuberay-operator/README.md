...
| kubernetesWAS.targetVersion | string | `""` | Pin the scheduling.k8s.io API version WAS uses. One of "v1beta1", "v1alpha3", or "v1alpha2" (v1alpha2 is served only on Kubernetes 1.36). Empty selects the most mature version the cluster serves. |
