...
const (
	...
	// RayCluster's whole-cluster PodGroup. Honored by the kubernetes-was v1beta1 and v1alpha3 providers
	// when the KubernetesWASPodGroupPreemptionPolicy feature gate is on. Values: "PreemptLowerPriority"
	// or "Never".
